...
// Дублировать pitchY отдельным полем состояния не нужно (и опасно: рассинхрон
// отдельно хранимых pitchY и визуального размера бисерины даёт зазор или наезд
// бисерин друг на друга) — вместо этого он всегда считается из pitchX по этой
// формуле.
