...
// Механика режима плетения, общая для всех четырёх техник (см. spec.md, «Режим
...
// проход нити от узла до узла, у крестика — ячейка из четырёх бисерин, у
// Peyote — целая колонка, у Loom — целый ряд. Оно вынесено в resolveStrokeIds
// и живёт в своём холсте рядом с остальной доменной геометрией.
