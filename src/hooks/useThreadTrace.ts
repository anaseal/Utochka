...
// Вся логика инструмента «нитка», общая для обеих техник (см. spec.md,
// «Нитка»): набор точек кликами, магнит к ближайшей бусине, перепрокладка
// конца существующей нитки за ручку, коммит и отмена. Раньше жила двумя
// почти дословными копиями в CanvasView и CrossWeaveCanvasView.
//
