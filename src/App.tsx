...
function App() {
  ...
  // её вкладки, а не две самостоятельные панели с двумя кнопками в хедере:
  // слот справа у них один на двоих, так что порознь они всё равно гасили бы
  // друг друга — вели бы себя как вкладки, не выглядя ими.
  // Вкладка живёт отдельно от «открыта/закрыта»:
