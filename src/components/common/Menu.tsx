...
export interface MenuItem {
  ...
  // Тултипа в API задачи не было, но он есть у половины пунктов хедера
  // («Make symmetric», названия техник, номера нитей), и без него миграции
  // 5.2–5.4 потеряли бы подсказки.
  title?: string;
  onClick: () => void;
}
