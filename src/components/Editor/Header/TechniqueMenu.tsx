...
// Попап-меню, а не pill из кнопок в ряд: четыре техники в такой pill не
// помещаются. Приём тот же, что у MirrorMenu/
...
//
// Иконка триггера — постоянный WeaveSwitchIcon (icons.tsx), а НЕ current.Icon:
