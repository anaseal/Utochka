...
// стоячий, — и дуга со стрелкой в свободном верхнем правом углу. Заменила
// lucide-иконку RotateCw: круглая стрелка говорит «повернуть», но не «повернуть
// что», а здесь предмет действия — сам лист схемы, и его видно. Пунктир — тот же
...
export const CanvasRotateIcon = ({ size = 14 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {/*
      ...
      x 13.5…21.5 / y 2.5…10.5 с зазором ≈1 от пунктирной грани: с прежним
      r=3 хвост дуги попадал круглым концом внутрь её обводки.
    */}
    <path
...
// «Изделие» на ≤599.98px, и две одинаковые иконки в одной строке читались бы
