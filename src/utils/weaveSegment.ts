...
//
// У Peyote и Loom группы прямоугольные и однозначны по одному индексу ID: у
// Peyote сегмент — целая колонка (peyoteColumnSegment), у Loom — целый ряд
// (loomRowSegment); почему именно так — в комментариях у самих функций.
//
 ...
 * себе — отметить её всё равно можно, просто в одиночку.
 */
