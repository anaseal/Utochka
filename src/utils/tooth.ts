...
// потребителе по-своему. Зубец без живого якоря (startCol/endCol не
...
// точечное (обычная подвеска) на них не ставится, см. spec.md,
// «Зубец». Декор-хвост и цепочки-подвески (grid-конец) этим не ограничены:
// ограничение сознательно касается только точечных подвесок.
