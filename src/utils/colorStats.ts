...
// Свод количества бисерин по цвету — общий для всех четырёх техник. Возвращает
// мутируемый Map (не массив), чтобы вызывающий код мог доусеять его
// дополнительными источниками (например, подвесками у силянки) поверх базового
// прохода по beads.
//
