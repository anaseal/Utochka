...
describe('translateBeadId — NODE, коррекция колонки при нечётном dRow', () => {
  ...
  it('якорь на чётном ряду: бисерина той же чётности не получает коррекцию', () => {
  ...
  it('якорь на чётном ряду: бисерина другой чётности получает +1 к колонке', () => {
  ...
  it('якорь на нечётном ряду: бисерина другой чётности получает -1 к колонке', () => {
  ...
  it('чётный dRow — коррекция не применяется независимо от чётности', () => {
