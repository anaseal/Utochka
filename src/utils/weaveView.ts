// Поворот/отражение полотна выполняются одной матрицей на внешней группе <svg>
// (см. CanvasView/CrossWeaveCanvasView/PeyoteCanvasView/LoomCanvasView) — всё
// содержимое наследует её автоматически. Подписи линеек — единственное, что
// при этом ломается: цифры ложатся набок и зеркалятся. Каждой подписи даётся
