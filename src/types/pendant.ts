...
// Конец цепочки — либо настоящий узел нижнего ряда, либо узел на
...
export interface PendantChain {
  placementId: string;
  /** Начало цепочки — порядок клика, никакой канонической сортировки: конец на
   * зубце адресуется парой (placementId, beadIndex), которую не с чем
